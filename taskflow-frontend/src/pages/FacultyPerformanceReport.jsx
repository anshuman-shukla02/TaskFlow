        ...
        return (
            <div className="h-screen flex items-center justify-center bg-slate-50">
                <div className="text-center">
                    <h2 className="text-2xl font-bold text-clay-text">No Report Found</h2>
                    <p className="text-clay-muted mt-2">Please generate a report from the dashboard first.</p>
                    <button
                        onClick={() => navigate("/faculty")}
                        className="mt-6 px-6 py-2 clay-btn-primary hover:scale-105 transition"
                    >
                        Go to Dashboard
                    </button>
                </div>
        ...
        <div className="min-h-screen bg-slate-50 p-8 print:p-0 print:bg-white">
            <div className="max-w-4xl mx-auto space-y-8 print:max-w-none print:w-full">
                ...
                <div className="flex items-center justify-between print:hidden">
                    <button
                        onClick={() => navigate(-1)}
                        className="flex items-center gap-2 text-clay-secondary hover:text-black transition"
                    >
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 clay-btn-primary hover:bg-slate-800 transition text-sm font-medium"
                        >
                ...
                <motion.div
                    ...
                    className="bg-white rounded-3xl p-10 shadow-lg border print:shadow-none print:border-none print:p-0"
                >
                    <div className="prose prose-lg prose-slate max-w-none prose-headings:font-bold prose-h2:text-indigo-600 prose-a:text-purple-600 hover:prose-a:text-blue-500 print:prose-sm">
                        <ReactMarkdown remarkPlugins={[remarkGfm]}>{report}</ReactMarkdown>
                    </div>
                </motion.div>

                {/* Footer Suggestion */}
                <div className="text-center text-clay-muted text-sm">
